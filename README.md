## Olá, Devs, tudo bom? Sejam todos bem-vindos!  👋

Desenvolvedor FullStack apaixonado por explorar tecnologias. Experiência sólida em HTML, CSS, JavaScript/Typescript e frameworks como Express, React.JS, Vue.JS e Nuxt 3. Versátil e sempre disposto a aprender, embarquei em projetos desafiadores, incluindo a criação de interfaces visuais impactantes e a otimização de experiências do usuário. Minha jornada começou como freelancer, onde dominei tecnologias em tempo recorde, como Vue.JS e Nuxt, para entregar projetos de sucesso. Minha ambição é crescer continuamente e agregar valor através do meu compromisso com a excelência. Em busca de novos desafios emocionantes para expandir ainda mais minhas habilidades e conhecimentos.
...
<img src=https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Typescript_logo_2020.svg/1200px-Typescript_logo_2020.svg.png height="50" alt="Typescript">
</div>
